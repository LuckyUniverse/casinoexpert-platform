...
4. Imagery: ALWAYS fetch the provider's official game page with web_fetch, and the penny-slot-machines.com review page too if it exists, and extract 2-4 direct image URLs showing the game. STRONGLY PREFER actual in-game screenshots - the reel grid, base game, bonus round, free spins screen - over logos, banner tiles, or box art. Review sites (SlotCatalog, Bigwinboard, penny-slot-machines.com) usually have screenshot galleries; provider pages have press-kit screenshots. A logo/tile is a last resort, never the majority of the set. Caption each image with what it shows (e.g. "Base game reels", "Free spins bonus"). Only include URLs you actually saw in fetched content or search results - never construct or guess an image URL. Prefer https URLs ending in .jpg/.png/.webp. Also always fill resolved.officialUrl - the results page derives extra imagery from it.
