...
/**
 * Interactive side-by-side comparison of up to 3 brands. Scoped to the 13
 * brands in our Canada coverage. Rendered as a client island by the server
 * page (app/compare/page.tsx); Next.js still SSRs the default selection into
 * the initial HTML, so the default comparison is crawlable.
 */
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="text-xs text-gray-500 mt-6 leading-relaxed max-w-3xl">
          ...
          two or three above to see them side-by-side. Read the full{" "}
          <Link href="/#casinos" className="text-blue-600 hover:underline">
            casino reviews
          </Link>{" "}
          or browse{" "}
