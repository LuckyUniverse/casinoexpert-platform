...
export const LUXURY_CASINO: CasinoConfig = {
 slug: "luxury-casino",
 name: "Luxury Casino",
 ...
 { label: "Formal ADR", value: "eCOGRA 'Safe and Fair' (RNG + ADR)" },
 ],
 ...
 keyCharacteristics: [
 {
 title: "Match-bonus structure (not 'chances')",
 description: "One of two Casino Rewards brands (with Golden Tiger) leading on multi-deposit % match bonuses instead of low-deposit Mega Money Wheel chances hooks.",
 },
 {
 ...
 description: "Casino.Guru's Gamecheck confirmed no counterfeit titles in the lobby. Independent verification of the game catalogue's integrity.",
 },
 {
 ...
 <p>Casino.Guru rates Luxury Casino a <strong>Very high Safety Index of 9.5/10</strong>, reasoning that it is a "very big" operator with a low dispute ratio for its size (11 cases logged: 2 resolved, 9 rejected, 0 unresolved), no blacklist appearances, and verified games with no fakes found. Casino.Guru fairly flags "somewhat unfair" terms (three clauses, including low-risk-play forfeiture and auto-play-during-bonus rules) as the trade-off worth knowing about.</p>
 <p>Trustpilot carries a <strong>4.3/5 TrustScore across roughly 4,870–5,000 reviews</strong> (73% five-star, 12% one-star). Players notice fast deposits, broad game variety and responsive support on the upside. The recurring fair-warning themes are slower withdrawals (often 2+ days), bonus wagering terms and perceived low slot RTP. The operator's <strong>97% reply rate on critical reviews</strong> is notably high.</p>
 ...
 <ul>
 <li>Deposit 1: <strong>100% match up to C$150</strong></li>
 <li>Deposit 2: <strong>50% match up to C$200</strong></li>
 <li>Deposit 3: <strong>25% match up to C$300</strong></li>
 ...
 <p>Luxury Casino is mobile-friendly via browser plus the Casino Rewards group's mobile apps. Mobile-web mirrors the desktop lobby on any modern smartphone.</p>
 <p>The group apps cover all 28 sister sites with a unified login.</p>
 `,
 ...
 <h3>RG references and tools</h3>
 <p>Luxury Casino's footer links to <strong>Gambling Therapy, GamCare, BeGambleAware and Gamblers Anonymous</strong>, plus provincial GameSense / PlaySmart resources (per the reputation pass; per-body memberships are not formally confirmed). Standard in-account tools (deposit limits, cooling-off, self-exclusion) are accessible from account settings once logged in.</p>
 ...
 faqs: [
 {
 question: "Is Luxury Casino legal for Canadian players?",
 answer:
 "Yes. Luxury Casino is operated by Fresh Horizons Ltd under Kahnawake Gaming Commission licence #00972 for Canadian players via the.com site. ",
 },
 {
 question: "How does the Luxury Casino welcome ladder break down?",
 answer:
 "Five deposits with a graduated front-loaded-then-mid-weighted shape: 100% match up to C$150 on deposit one, 50% up to C$200 on deposit two, 25% up to C$300 on deposit three, 50% up to C$200 on deposit four, 100% up to C$150 on deposit five. Headlined as '$150 free to start'. Wagering not stated on the bonus page; group T&Cs apply.",
 },
 {
 ...
 answer:
 "Casino.Guru rates it 9.5 'Very high' Safety Index. The brand has a low dispute ratio for its size (11 cases logged, 2 resolved / 9 rejected / 0 unresolved), no blacklist appearances, and verified games with no fakes found per Gamecheck. Trustpilot 4.3 across ~5,000 reviews with a 97% operator reply rate on critical reviews supports the same picture.",
 },
 {
 question: "How does Luxury Casino compare to Golden Tiger?",
 answer:
 "Both are Casino Rewards brands leading on match-bonus structures rather than 'chances' hooks. Golden Tiger runs the bigger ladder (up to C$1,500 across five deposits) with an RTP / 'Highest Win Rate' guarantee. Luxury runs a graduated ladder where the middle deposits carry the largest caps (up to C$300). Same operator, same Kahnawake licence, same software backbone.",
 },
 {
